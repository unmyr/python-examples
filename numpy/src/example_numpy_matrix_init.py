...
print(
    "mat_empty(size:{}, ndim:{}, shape:{}, dtype:{}):\n{}".format(
        mat_empty.size, mat_empty.ndim, mat_empty.shape, mat_empty.dtype, mat_empty
    )
)
...
print(
    "mat_zeros(size:{}, ndim:{}, shape:{}, dtype:{}):\n{}".format(
        mat_zeros.size, mat_zeros.ndim, mat_zeros.shape, mat_zeros.dtype, mat_zeros
    )
)

mat_ones = np.ones((3, 4), np.int16)
print(
    "mat_ones(size:{}, ndim:{}, shape:{}, dtype:{}):\n{}".format(
...
print(
    "mat_rand(size:{}, ndim:{}, shape:{}, dtype:{}):\n{}".format(
