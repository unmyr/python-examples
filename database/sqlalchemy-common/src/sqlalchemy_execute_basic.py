...
class FruitsMenu(Base):
    ...
    id = sqlalchemy.Column(sqlalchemy.Integer, primary_key=True)  # emits SERIAL
    ...
    mod_time = sqlalchemy.Column(sqlalchemy.DateTime, server_default=sqlalchemy.sql.func.now())
...
def execute_query(driver_name: str, engine: sqlalchemy.engine.base.Engine) -> typing.Dict:
    """Execute query."""
    query_results = []
