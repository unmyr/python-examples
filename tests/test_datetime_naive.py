...
class TestDateTime(unittest.TestCase):
    ...
    def test_string_dt_naive_fromisoformat(self):
        ...
        assert (
            datetime.datetime.fromisoformat("2021-11-13 11:49:20.673681")
            == dt_obj_with_us
        )
        assert (
            datetime.datetime.fromisoformat("2021-11-13T11:49:20.673681")
            == dt_obj_with_us
        )

        dt_obj_with_ms = datetime.datetime(2021, 11, 13, 11, 49, 20, 673000)
        assert (
            datetime.datetime.fromisoformat("2021-11-13 11:49:20.673") == dt_obj_with_ms
        )
        assert (
            datetime.datetime.fromisoformat("2021-11-13T11:49:20.673") == dt_obj_with_ms
        )
        ...
        assert (
            datetime.datetime.fromisoformat("2021-11-13 11:49:20.000")
            == dt_obj_with_sec
        )
        assert (
            datetime.datetime.fromisoformat("2021-11-13 11:49:20.000000")
            == dt_obj_with_sec
        )
    ...
    def test_string_dt_naive_isoformat(self):
        ...
        assert (
            dt_iso8601_str == "2021-11-13T11:49:20.673000"
    ...
    def test_timezone_naive_jst_to_aware_jst_combine(self):
        ...
        datetime_aware_jst = datetime.datetime.combine(
            datetime_naive_jst.date(),
            datetime_naive_jst.time(),
    ...
    def test_timezone_naive_jst_to_aware_jst_replace(self):
        ...
        datetime_aware_jst = datetime_naive_jst.replace(
            tzinfo=datetime.timezone(datetime.timedelta(hours=9))
        )
        assert datetime_aware_jst == datetime.datetime(
            2021,
